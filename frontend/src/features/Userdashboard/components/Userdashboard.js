                              ...
                              <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5">
                                <div className="relative  bg-white   lg:grid-cols-2">
                                  ...
                                  <ul class="py-1" role="none">
                                    <li>
                                      <p
                                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                                        role="menuitem"
                                      >
                                        Settings
                                      </p>
            ...
            <ul className="space-y-2 mt-4 font-medium">
              ...
              <li>
                ...
                >
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">CHAT with Doctors</span>
                </a>
              </li>
            </ul>
          </div>
